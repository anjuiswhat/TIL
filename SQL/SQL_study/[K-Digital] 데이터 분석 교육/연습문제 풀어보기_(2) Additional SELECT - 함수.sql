...
SELECT  student_no, student_name,
        LPAD( SUBSTR(student_ssn, 1, 2), 4, '19') 출생년도,
        TO_CHAR(entrance_date,'YYYY') AS 입학년도,
        TO_CHAR(entrance_date,'YYYY') - LPAD( SUBSTR(student_ssn, 1, 2), 4, '19') AS 입학나이
    FROM tb_student
    ORDER BY 입학나이;
...
-- 학기 별 평점, 년도 별 평점, 년도 별 누적 평점 , 총 평점을 구하는 SQL 문을 작성하시오.
